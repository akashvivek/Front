...
import about1 from "../assets/about/pic-1.jpg";
import about2 from "../assets/about/pic-2.jpg";
import about3 from "../assets/about/pic-3.jpg";
...
import dotciricle from "../assets/shap/circle-dots.png"
import linecircle from "../assets/shap/line-circle-blue.png"
import "./About.css"
const About = () => {
  return (
    <><div className='w-fit xl:h-[70vh] h-fit my-2 mx-auto mt-28 z-10'>
          <div class="grid grid-rows-3 grid-flow-row xl:grid-flow-col mx-auto">
              <div class="row-span-3 mx-auto">
                  <div className="grid grid-cols-2 gap-4 my-8 w-72 mx-16">
                      <img className='rounded-r-[50px] rounded-bl-[50px] w-[275px] max-h-full' id='img1' src={about1} alt="" />
                      <img className='rounded-l-[50px] rounded-b-[50px] w-[275px] max-h-full' id='img2' src={about2} alt="" />

                      <img className='rounded-r-[50px] rounded-tl-[50px] w-[275px] max-h-full' id='img3' src={about3} alt="" />
                      <a href="/#" class="block max-w-sm bg-white rounded-l-[50px] rounded-tr-[50px] border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-violet-500 dark:hover:bg-violet-300 w-42 ">
                          <h5 class="sm:text-7xl text-5xl font-bold tracking-tight text-purple-900 dark:text-purple-800 mt-9 text-center">200+</h5>
                      </a>

                  </div>
              </div>
              <div class="col-span-2 my-10 ">
                  <p className='bg-text-bgy bg-center bg-repeat text-orange-500 font-bold w-28 mx-auto text-2xl sm:mb-16 sm:ml-14 lg:mx-auto'>About Us</p>
                  <p className='bg-transparent text-blue-800 text-4xl font-bold my-12 w-3/5 mx-8'>We Care for You, We are for Healthcare</p>
              </div>
              <div class="row-span-2 col-span-2">
                  <div class="grid gap-4 grid-cols-1 mx-8 md:grid-cols-2 lg:-my-8">
                      <div className='border-2 solid border-sky-300 h-16 flex'>
                          <span className=' bg-sky-100 rounded-r-[30px] px-6 overflow-hidden py-auto'>
                              <svg enable-background="new 0 0 512 512" height="45" viewBox="0 0 512 512" width="45" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className='font-bold text-blue-800 my-auto mx-auto lg:px-16'>Tele-Healthcare</p>
                      </div>
                      <div className='border-2 solid border-green-300 h-16 flex z-10'>
                          <span className=' bg-emerald-100 rounded-r-[30px] px-6 overflow-hidden py-auto'>
                              <svg enable-background="new 0 0 512 512" height="45" viewBox="0 0 512 512" width="45" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className='font-bold text-emerald-700 my-auto mx-auto lg:px-10'>Emergency consultation</p>
                      </div>
                      <div className='border-2 solid border-red-300 h-16 flex z-10'>
                          <span className=' bg-red-100 rounded-r-[30px] px-6 overflow-hidden py-auto'>
                              <svg enable-background="new 0 0 512 512" height="45" viewBox="0 0 512 512" width="45" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className='font-bold text-red-600 my-auto mx-auto lg:px-16'>Managing Report</p>
                      </div>
                      <div className='border-2 solid border-purple-300 h-16 flex z-10'>
                          <span className=' bg-violet-100 rounded-r-[30px] px-6 overflow-hidden py-auto'>
                              <svg enable-background="new 0 0 512 512" height="45" viewBox="0 0 512 512" width="45" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className='font-bold text-purple-800 my-auto mx-auto lg:px-16'>Medicine Order</p>
                      </div>
                  </div>
              </div>
      <img src={triangle} className="absolute top-[130%] left-[50%] animate-bounce z-0" id="triangle" alt="/" />
      <img src={square} className="absolute top-[155%] left-[5%] animate-pulse z-0" id="square" alt="/" />
      <img src={plus} className="absolute top-[160%] left-[43%] animate-ping z-0" id="plus" alt="/" />
      <img src={wave} className="absolute top-[175%] left-[65%] animate-pulse z-0" id="wave" alt="/" />
      <img src={dotciricle} className="absolute top-[195%] left-[75%] animate-spin z-0" id="dotcircle" alt="/" />
      <img src={linecircle} className="absolute top-[195%] left-[20%] animate-pulse z-0" id="linecircle" alt="/" />         
       </div>
      </div>
      </>
  )
