...
import { clearErrors, appointment } from "../actions/appointedPatientAction";
...
const Appointment = () => {
  ...
  const { name, phone, age, problemcat, gender, dhst, allrg, history } = appoint;
          ...
          <div className="colums">
            ...
            <div className="item">
              ...
              <select
                ...
                className="options"
              >
                <option type="text" name="problemcat" onChange={registerDataChange}>
                  Problem Category
                </option>
                <option
                  type="text"
